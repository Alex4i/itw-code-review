...
class EnergyConsumptionServiceUnitTest {
    ...
    public void testGetTotalConsumption() {
        ...
        entity.setClientId("POD123");
        entity.setValueKwh(10.5);
        entity.setTimestamp(now);

        when(repository.findByClientIdAndTimestampBetween("POD123", yda, now))
        ...
        verify(repository).findByClientIdAndTimestampBetween("POD123", yda, now);
    }
}
